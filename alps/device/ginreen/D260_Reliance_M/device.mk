...
include device/ginreen/$(MTK_TARGET_PROJECT)/ProjectConfig.mk
...
# CTS Video
PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/media_codecs_performance.xml:system/etc/media_codecs_performance.xml

# overlay has priorities. high <-> low.
DEVICE_PACKAGE_OVERLAYS += device/ginreen/$(MTK_TARGET_PROJECT)/overlay

PRODUCT_COPY_FILES += vendor/mediatek/proprietary/frameworks/opt/GeoCoding/geocoding.db:system/etc/geocoding.db

#######################################################

# PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/egl.cfg:system/lib/egl/egl.cfg
# PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/ueventd.mt6735.rc:root/ueventd.mt6735.rc

PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/meta_init.project.rc:root/meta_init.project.rc

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl \
                      device/ginreen/D260_Reliance_M/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm
endif

# Add FlashTool needed files
#PRODUCT_COPY_FILES += device/ginreen/$(MTK_TARGET_PROJECT)/EBR1:EBR1
#ifneq ($(wildcard device/ginreen/$(MTK_TARGET_PROJECT)/EBR2),)
#  PRODUCT_COPY_FILES += device/ginreen/$(MTK_TARGET_PROJECT)/EBR2:EBR2
#endif
#PRODUCT_COPY_FILES += device/ginreen/$(MTK_TARGET_PROJECT)/MBR:MBR
#PRODUCT_COPY_FILES += device/ginreen/$(MTK_TARGET_PROJECT)/MT6735_Android_scatter.txt:MT6735_Android_scatter.txt

# thermal policy
ifeq ($(TARGET_BUILD_VARIANT),eng)
    PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/thermal_6753_eng.conf:system/etc/.tp/thermal.conf
else
    PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/thermal_6753.conf:system/etc/.tp/thermal.conf
endif

PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/thermal.wfd.6753.conf:system/etc/.tp/.thermal_policy_00
...
PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/D260_Reliance_M/factory/res/sound/testpattern1.wav:system/res/sound/testpattern1.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/D260_Reliance_M/factory/res/sound/ringtone.wav:system/res/sound/ringtone.wav

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6735/ACCDET.kl:system/usr/keylayout/ACCDET.kl
PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl

# Microphone
PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/ginreen/D260_Reliance_M/audio_policy.conf:system/etc/audio_policy.conf

#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/D260_Reliance_M/factory/res/images/lcd_test_00.png:system/res/images/lcd_test_00.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/D260_Reliance_M/factory/res/images/lcd_test_01.png:system/res/images/lcd_test_01.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/D260_Reliance_M/factory/res/images/lcd_test_02.png:system/res/images/lcd_test_02.png
...
DEVICE_PACKAGE_OVERLAYS += device/ginreen/D260_Reliance_M/overlay
...
$(call inherit-product-if-exists, vendor/ginreen/libs/$(MTK_TARGET_PROJECT)/device-vendor.mk)
...
PRODUCT_PACKAGES += WOSSmartCover 
endif
